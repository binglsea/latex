...
SVG\index{SVG, Scalable Vector Graphics} 1.1中定义了147 种颜色的英文名\footnote{ \texttt{https://www.w3.org/TR/SVG11/types.html}}.
...
最常用的则是 HTML\footnote{HTML (HyperText Markup Language 超文本标记语言)是一种用于创建网页的标准标记语言}
\index{HTML 超文本标记语言} 4.01 最初支持的 16 种基本颜色, 如图 \ref{fig:1.4.3}.
