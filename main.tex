...
\subfile{math/math_prelim.tex}
\subfile{math/number_bases.tex}
\subfile{math/paper_sizes.tex}
\subfile{math/colors.tex}

\part{Python 编程}
\chapter{选择 Python 开发环境，安装软件}\label{sec:II.2}
\subfile{py/py_install.tex}

\section{常用进位制}\label{sec:I.2}
\subfile{py/nadic.tex}


\newpage\part{PostScript 编程作图}
\section{Some graphs}
\subfile{ps/3.1.tex}
