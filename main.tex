...
% package for colors
\usepackage{xcolor}
\usepackage[contents=征求意见稿22.11]{background}
...
\title{\begin{kaishu}数学：编程与可视化\end{kaishu}\\
...
\chapter{图: 更优美地表达数学和数学证明}\label{ch2}
\section{作图证明}
\subfile{chap2/graphs.tex}

\part{\begin{lishu}Python 编程\end{lishu}}\label{partII}
\chapter{Python 入门}\label{ch3}
%\section{关于 Python}\subfile{chap3/py_intro.tex}\label{ch3.1}
\subfile{chap3/py_intro.tex}  %\section{关于 Python}

\section{安装 Python 开发环境软件集 Anaconda}
 \subfile{chap3/py_install.tex}\label{ch3.2}

\section{初识 Spyder}
 \subfile{chap3/spyder1.tex}\label{ch3.3}
\section{初识 Jupyter}
\subfile{chap3/jupyter1.tex}\label{ch3.4}

\section{常用进位制}\label{ch3.5}
